  ...
  return (
    <div className="pt-20 min-h-screen bg-parchment">
      ...
      <div className="relative bg-green-dark py-16 px-4 text-center overflow-hidden">
        ...
        <h1 className="font-heading text-5xl font-black text-cream">Información</h1>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-green-dark rounded-full flex items-center justify-center">
                <span className="text-cream text-xs font-bold">RP</span>
              </div>
              <h2 className="font-heading text-3xl text-green-dark font-bold">Sobre nosotros</h2>
            </div>
            <div className="space-y-4 font-body text-brown/80 text-base leading-relaxed">
              <p>
                El Racó del Pantà nació del sueño de ofrecer una experiencia gastronómica auténtica en
                un entorno natural incomparable. Ubicados junto al pantano, entre montañas y agua,
                nuestro restaurante fusiona la cocina tradicional catalana con técnicas de brasa artesanal
                para crear platos que evocan la esencia de la tierra.
              </p>
              <p>
                Cada producto que llega a nuestra cocina es seleccionado con mimo de productores locales
                comprometidos con la calidad y la sostenibilidad. Nos enorgullece ofrecer una carta de
                temporada que cambia con el ritmo de la naturaleza, siempre con el sabor auténtico de
                nuestra comarca como protagonista. ¡Recién abiertos y con mucha ilusión!
              </p>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-cream rounded-2xl p-6 border border-wood/30">
              ...
              <div className="space-y-2 font-body text-sm">
                ...
                {['Martes', 'Miércoles', 'Jueves', 'Viernes'].map((day) => (
            ...
            <div className="bg-cream rounded-2xl p-6 border border-wood/30">
              ...
              <div className="space-y-3 font-body text-sm text-brown">
                ...
                <div className="flex gap-3">
                  <span className="text-green-mid">✉️</span>
